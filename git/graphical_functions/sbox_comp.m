% sbox_comp(A, x_name, y_name, tit, box_names,sig_dif, acsis)
%
...
for a = 1:max(auxgroup)
    ...
    plot(x,y, clor,'LineWidth',lw)
    plot((a + 0.025*randn(1,length(find(group_id == a)))), data( find(group_id == a) ), 'ob', 'MarkerSize', ms, 'MarkerFaceColor', 'b') %#ok<FNDSB>
end
