...
A{par}=T(a:a+999); %Cria um vetor para cada participante dizendo em quais posições cada participante acertou ou errou
...
title(strcat('Distribuição de tempo de resposta de cada participante em cada bloco'));
ylabel("tempos");
ylim([0 2.5])
yticks([0:0.2:2.5])
xticks([1.5 3.5 5.5])
