...
predata_control = readtable('C:\Users\Pedro_R\Desktop\Projeto\Code_exp_ltpb\Rotina_Dados _Quest\dataframe_Patient.csv');
predata_control(: , 1) = [ ]; 
predata_control(: , 1) = [ ];
...
title('Média Móvel Temporal - Completo') %Mudar o nome de acordo com o arquivo aberto
xlabel("Número da Jogada")
ylabel("RTs")
